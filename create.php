    ...
    $doc = <<<jsonld
{
  "@graph" : [
    ...
    },
    {
      ...
      "https://schema.org/description": "This is a dataset of molecules generated by MEgen.",
      ...
      "https://schema.org/temporal": "$year",
      "https://schema.org/url": "https://github.com/lszeremeta/MEgen"
    },
...
ds;
    ...
    for ($i = 1; $i <= $count; $i++) {
        ...
        $doc = $doc . "    <div itemscope itemtype='https://schema.org/MolecularEntity' itemid='$subject1'>";
        if ($identifier1 != '') {
